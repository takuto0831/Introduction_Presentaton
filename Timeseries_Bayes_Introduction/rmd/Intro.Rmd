...
トレンド項$\alpha_t$と季節調整項$season_t$, 観測ノイズ$\epsilon_t$を含むモデルを考える. 季節調整項は周期$L$の周期性を持ち, 任意の連続した$L$個の$\sum_{l=0}^{L-1} season_{t-l}$の和は常に小さい値$\epsilon_{season,t}$になると仮定する.
